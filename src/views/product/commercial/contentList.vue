<template>
  ...
  <a-breadcrumb>
    ...
    <a-breadcrumb-item>内容目录</a-breadcrumb-item>
  </a-breadcrumb>
  <div class="mt20">
    <a-button type="primary"  @click="resetForm();visible = true;">新建</a-button>
  </div>
    ...
    >
      ...
      <a-form-item
        ...
        <a-select v-model:value="form.box">
          <a-select-option :value="el.id" v-for="el in box.list" :key="el.id">{{el.text}}</a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item
        label="代币金额"
